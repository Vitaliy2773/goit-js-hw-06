...
const list = images.map((image) => `<li class="img"><img url: ${image.url}, alt: ${image.alt}></li>`).join("");
console.log(list);

imagesWrapper.insertAdjacentHTML("afterbegin", list);

// imagesWrapper.innerHTML = <li><img class="1" ></li>
